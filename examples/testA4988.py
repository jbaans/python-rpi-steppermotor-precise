...
import time
import getopt
from steppermotor_precise import AutoA4988

# these are the GPIO pins the A4988 ports are tied to:
GPIOS = {
    "enable":23,
    "step":24,
    "direction":25,
...
if __name__ == "__main__":
    ...
    try:
        motor = AutoA4988(GPIOS, frequency, accel_microsteps=accel_microsteps, verbosity=verbosity)
        motor.enable()
